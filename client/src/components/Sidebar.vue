<template>
  <div id="sidebar">
    ...
    <div
      class="p-12 -ml-4 text-lg rounded md:py-24 xl:mt-10 xl:px-16 md:mt-10 lg:mt-auto"
      id="sidebar-content"
    >
      <div class="my-8">
      ...
      <div class="my-16">
        <router-link :to="{ name: 'Public' }">
          <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.25em" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
